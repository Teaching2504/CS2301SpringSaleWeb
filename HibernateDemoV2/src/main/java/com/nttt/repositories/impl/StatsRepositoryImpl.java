...
public class StatsRepositoryImpl {
    public List<Object[]> statsrevenueByProduct(){
        try (Session s = HibernateUtils.getFACTORY().openSession()){
            ...
            Join<OrderDetail, Product> join =root.join("orderId", JoinType.RIGHT);
    ...
    public List<Object[]> StasRevenueByTime(String time, int year){
             try (Session s = HibernateUtils.getFACTORY().openSession()){
            CriteriaBuilder b = s.getCriteriaBuilder();
            CriteriaQuery<Object[]> q = b.createQuery(Object[].class);
            ...
            q.multiselect(b.function("MONTH",Integer.class,join.get("createdDate")),
                    b.sum(b.prod(root.get("unitPrice"),root.get("quantity"))));
